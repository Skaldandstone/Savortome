...
| [docs/RESTAURANT-DISCOVERY.md](docs/RESTAURANT-DISCOVERY.md) | Proposed dish and restaurant discovery, dietary boundaries, review evidence, and dining-environment preferences; not implemented |
