...
$image='574921529762.dkr.ecr.us-east-2.amazonaws.com/secondbreakfast-web@sha256:'+('a'*64)
$commit='d'*40
$oldImage='574921529762.dkr.ecr.us-east-2.amazonaws.com/secondbreakfast-web@sha256:'+('b'*64)
...
$oldArn='arn:aws:ecs:us-east-2:574921529762:task-definition/secondbreakfast-web:10'
$assertions=0
...
function Reset {
  $global:BetaReleaseMock=@{
    account='574921529762';calls=[Collections.Generic.List[object]]::new();counter=10;failUpdate=$false;dockerCalls=0;
    ...
    build=[pscustomobject]@{id=$buildId;arn="arn:aws:codebuild:us-east-2:574921529762:build/$buildId";projectName='secondbreakfast-web-build';buildStatus='SUCCEEDED';sourceVersion=$commit;resolvedSourceVersion=$commit;source=@{type='GITHUB';buildspec=$spec};artifacts=@{sha256sum=''}};
...
function global:aws {
  ...
  switch("$($Arguments[0]) $($Arguments[1])") {
    ...
    'ecs register-task-definition' {
      $s.counter++;@{taskDefinition=@{taskDefinitionArn="arn:aws:ecs:us-east-2:574921529762:task-definition/secondbreakfast-web:$($s.counter)"}}|ConvertTo-Json
    }
    'ecs update-service' {
...
Reset;$global:BetaReleaseMock.build.source.type='S3';$global:BetaReleaseMock.build.source.location='secondbreakfast-build-source-574921529762/reviewed.zip';$global:BetaReleaseMock.build.sourceVersion='pinned-object-version';$zip=ReportZip
...
$rollbackBuild.id=$rollbackBuildId;$rollbackBuild.arn="arn:aws:codebuild:us-east-2:574921529762:build/$rollbackBuildId"
