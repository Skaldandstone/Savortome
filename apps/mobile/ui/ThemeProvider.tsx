...
/** A reading panel may use parchment ink without changing the user's theme. */
export function PaletteScope({ palette, children }: { palette: Palette; children: ReactNode }) {
