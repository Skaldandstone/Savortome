...
export default function LegalScreen() {
  ...
  return <SafeAreaView style={{ flex: 1, backgroundColor: c.bg }}>
    <ScrollView contentContainerStyle={{ padding: 24, gap: 20 }}>
      <Text accessibilityRole="header" style={{ color: c.text, fontSize: 26, fontWeight: '700' }}>About Second Breakfast</Text>
      ...
      <Link href="/" style={{ color: c.accent, fontSize: 16, minHeight: 48, paddingVertical: 12 }}>Back to Second Breakfast</Link>
    </ScrollView>
  </SafeAreaView>;
}
