...
export default function LegalScreen() {
  ...
  return <SafeAreaView style={{ flex: 1, backgroundColor: c.bg }}>
    <ScrollView contentContainerStyle={{ padding: 24, gap: 20 }}>
      <Text accessibilityRole="header" style={{ color: c.text, fontSize: 26, fontWeight: '700' }}>About Savortome<Text style={{ color: c.text, fontSize: 13, fontWeight: '400', top: -6 }}>™</Text></Text>
